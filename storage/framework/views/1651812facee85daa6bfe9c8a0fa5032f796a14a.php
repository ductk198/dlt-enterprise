    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button id='btn_submit_import' class="btn btn-primary btn-flat" onclick="JS_Enterprise.saveimport()" type="button"><?php echo e(Lang::get('System::Common.submit')); ?></button>
