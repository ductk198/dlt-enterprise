<form id="frmChangePassword" role="form" action="" method="POST" class="form-horizontal">
  ...
  <input type="hidden" id="urlupdate" value="<?php echo e(url('system/login/updateChangePassword')); ?>">
...
<script type="text/javascript" src="<?php echo e(URL::asset('public/js/assets/jquery.validate.js')); ?>"></script>
<script>
