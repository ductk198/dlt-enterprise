...
<form action="index" method="POST" id="frmlist_index">
    ...
    <section class="content-wrapper">
        <ol class="breadcrumb" >
            <li><a role="button"><i class="fa fa-list"></i> <?php echo e(Lang::get('System::Modul.tittleenterprise')); ?></a></li>
        </ol>
            ...
            <div class="panel-body">
                ...
                <div class="row form-group input-group-index">
                    <div class="pull-right">
                        ...
                        <button class="btn btn-primary btn-flat" id="btn_import" type="button" data-toggle="tooltip"  data-original-title="<?php echo e(Lang::get('System::Common.import')); ?>"><i class="fa fa-upload"></i></button>
...
<script type="text/javascript">
    ...
    var JS_Enterprise = new JS_Enterprise(baseUrl, 'system/enterprise', 'enterprise');
    jQuery(document).ready(function ($) {
        JS_Enterprise.loadIndex();
    })
</script>
