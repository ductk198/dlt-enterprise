                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="site-login">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form id="frm_login" action="<?php echo e(url('system/login/checklogin')); ?>" method="POST" role="form">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="password" id="password" class="<?php echo e($class); ?>" name="password" placeholder="Mật khẩu">
                                                            <?php if($message !== ''): ?>
                                                            <label for="password" generated="true" class="error"><?php echo e($message); ?></label>
                                                            <?php endif; ?>
                                                        </div>                               
                                                    </div>
                                                </form>
