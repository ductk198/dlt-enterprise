        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <input class="form-control input-md" type="text" id="C_CODE" name="C_CODE" value="" xml_data="false" column_name="C_CODE">
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-3 control-label required">Tên chức vụ</label>
                    <div class="col-md-6">
                        <div class="input-group">
                           <input class="form-control input-md" type="text" id="C_NAME" name="C_NAME" value="" xml_data="false" column_name="C_NAME">
                        </div>
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            <input class="form-control input-md" type="text" id="C_ORDER" name="C_ORDER" value="{{$order}}" xml_data="false" column_name="C_ORDER">
                        </div>
                    </div>
                </div>
                <div class="row form-group">
