		...
		<div class="row">
				...
				<div class="row">
					...
					<div class="col-md-8">
						<select class="form-control" id="group_unit" name="group_unit">
						    ...
						    <option @if ($data['C_TYPE_GROUP'] == 'SO_NGANH') selected @endif value="SO_NGANH">Sở Ngành</option>
						    <option @if ($data['C_TYPE_GROUP'] == 'QUAN_HUYEN') selected @endif value="QUAN_HUYEN">Quận Huyện</option>
					  	</select>
					</div>
				</div>
			</div>
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-8">
						<label><input {!! $check_dvtk !!} type="checkbox" id="check_dvtk" name="check_dvtk">Đơn vị là đơn vị triển khai</label>
					</div>
				</div>
			</div>
			 <div class="col-md-6">
