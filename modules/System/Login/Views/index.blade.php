...
<html lang="vi"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">  
        ...
        <link href="{{URL::asset('public/css/backend/login/main.css')}}" rel="stylesheet">
        ...
        <script type="text/jscript" src="{{URL::asset('public/js/backend/Login/JS_Login.js')}}"></script>
        <script type="text/jscript" src="{{URL::asset('public/js/assets/jquery.validate.js')}}"></script>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="site-login">
                                        <!--                        <div class="row">
                                                                    <img src="{{URL::asset('public/images/logo.jpg')}}" alt="" class="img-responsive" style="width: 250px;margin: 0 auto">
                                                                </div>-->
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form id="frm_login" action="{{url('system/login/checklogin')}}" method="POST" role="form">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <input type="password" id="password" class="{{$class}}" name="password" placeholder="Mật khẩu">
                                                            @if($message !== '')
                                                            <label for="password" generated="true" class="error">{{$message}}</label>
                                                            @endif
                                                        </div>                               
                                                    </div>
                                                </form>
