    ...
    <div class="col-xs-12 col-sm-9">
        ...
        <div>
            <form class="t-form form_action" action="" method="">
                <div class="col-sm-12 input-group">
                    <input type="text" class="form-control input-lg" placeholder="Điền tên công ty hoặc mã số thuế" name="search" value="{{$search}}">
        ...
        <div>
            ...
            foreach($arrData as $key =>$value){
                ...
                echo '     <a href="/Enterprise/'.$value->TENCONGTYURL.'-'.$value->MASOTHUE.'.html">'.$value->TENCONGTY.'</a> <p>';
                echo '     <strong>Địa chỉ</strong>: <span>'.$value->DIACHITRUSOCHINH.'</span><br>';
                echo '     Mã số thuế: <a href="/Enterprise/'.$value->TENCONGTYURL.'-'.$value->MASOTHUE.'.html">';
                echo $value->MASOTHUE;
                echo ' </div>';
            }
            @endphp
