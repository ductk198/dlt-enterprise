...
<div class="modal-content">
  ...
  $arrWorks =  $data[1];
  ?>
  <div class="modal-header infor-record">
		<button class="close" type="button" data-dismiss="modal"><i class="fa fa-window-close" aria-hidden="true"></i></button>
		<h4 class="modal-title">THÔNG TIN TIẾN ĐỘ GIẢI QUYẾT HỒ SƠ</h4>
	</div>
